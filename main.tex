 ...
 \begin{@twocolumnfalse}
  ...
  \positiontextbox{2.0cm}{25cm}{
   ...
   \parbox{\textwidth}{%
    ...
    \hei\makebox[\widthof{\makebox{*}收}][r]{\makebox{*}通}信作者：E-mail：__@bupt.edu.cn
   }}
 \end{@twocolumnfalse}
]
 ...
 \begin{@twocolumnfalse}\vspace*{0.3cm}
  \begin{center}
   \parbox{\textwidth}{
    ...
    \vspace{-10pt}\wuhao
    {
     ...
     \textbf{Key words:} transfer learning; keyword2; keyword3; keyword4; keyword5
    }
   }
  \end{center}
  ...
  \positiontextbox{2.0cm}{16cm}{
   ...
   \parbox{\textwidth}{%
    ...
    \hei\makebox[\widthof{\makebox{*}\textbf{C}}][r]{\makebox{*}\textbf{C}}\textbf{orresponding author.} E-mail: ___@bupt.edu.cn
   }}
 \end{@twocolumnfalse}
]
